WITH revenue_trends AS (
    SELECT
        ...
        SUM(l.price_final * l.minimum_nights) OVER (PARTITION BY l.listing_id ORDER BY r.review_date ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) AS rolling_weekly_revenue
